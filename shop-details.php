                        ...
                        <div class="product__details__text">
                            ...
                            <div class="product__details__cart__option">
                                <form method="POST" action="shopping-cart.php">
                                    ...
                                    <button type="submit" name="add_to_cart" class="primary-btn"><i class="fa fa-shopping-cart"></button></i>
                            ...
                            <div class="product__details__last__option">
                                ...
                                <ul>
                                    ...
                                    <li><span>Categories:</span> <?php echo $row['product_category']; ?> Clothes</li>
